...
def main(states, images_folder, video=None):
    ...
    if video != None:
        ...
        p = subprocess.Popen(["ffmpeg", "-y", "-framerate", "15", "-i", os.path.join(images_folder, r"image_%06d.png"), "-c:v", "libx264",  "-r", "30", "-preset", "veryfast", "-qp", "0", "-f", "mp4", video], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        p.communicate()
